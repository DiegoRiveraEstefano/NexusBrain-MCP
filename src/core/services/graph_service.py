...
class GraphRAGService:
    ...
    async def get_graph_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            query_edges = (
                "SELECT id, in AS source_node, out AS target_node FROM DEPENDS_ON LIMIT 10;"
            )
            ...
            return {"nodes": extract(nodes_result), "edges": extract(edges_result)}
        finally:
    ...
    async def simulate_query(self, query: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if blast_records and blast_records[0].get("impacted_files"):
                ...
                impacted = (
                    [item for sublist in imp for item in sublist]
            ...
            if deps_records and deps_records[0].get("dependencies"):
                ...
                dependencies = (
                    [item for sublist in deps for item in sublist]
